...
### Changed
  ...
  - [#82](https://github.com/aeon-php/calendar/pull/82) - **phpunit/phpunit from 9.4.4 to 9.5.0** - [@dependabot[bot]](https://github.com/apps/dependabot)
  - [#80](https://github.com/aeon-php/calendar/pull/80) - **phpunit/phpunit from 9.4.3 to 9.4.4** - [@dependabot[bot]](https://github.com/apps/dependabot)
...
### Changed
  ...
  - [#76](https://github.com/aeon-php/calendar/pull/76) - **phpunit/phpunit from 9.4.2 to 9.4.3** - [@dependabot[bot]](https://github.com/apps/dependabot)
...
### Changed
  ...
  - [#74](https://github.com/aeon-php/calendar/pull/74) - **phpunit/phpunit from 9.4.1 to 9.4.2** - [@dependabot[bot]](https://github.com/apps/dependabot)
